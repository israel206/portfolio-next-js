    ...
    <div className="flex flex-col flex-grow px-6 pt-1 ">
      <h6 className="my-3 text-base font-medium">
        Oi! Meu nome é Israel Pereira da Silva. Sou desenvolvedor FullStack e sou muito apaixonado e dedicado
          ao meu trabalho. Com 5 anos de experiência na academia como desenvolvedor FullStack, 
          adquiri as habilidades e conhecimentos necessários para tornar seu projeto um sucesso. 
          Gosto de todas as etapas do processo desenvolvimento, Planejamento, design, discussão, codificação, teste e execução adiante...
      </h6>
      <div
